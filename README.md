...
Respect de la vie privée : Aucune clé API requise, pas de dépendance aux serveurs Google.

Optimisé pour les performences : S'active uniquement sur demande pour ne pas consommer de ressources en jeu.

Contrôle Système : Éteindre, redémarrer, déconnecter ou verrouiller le PC à la voix.

Recherche Web : Capable de trouver des liens vidéos (ex: sollalotode.fr) ou des infos sur le web si besoin.

Mémoire : Se souvient de vos préférences et de l'historique de la conversation.

  Installation :
Installer Python : Téléchargez la version 3.12 sur python.org.
